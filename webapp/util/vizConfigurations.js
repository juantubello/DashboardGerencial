sap.ui.define([
	...
	return {
		createTiempoCicloPopOver: function (centro, fechaDesde, fechaHasta, object, sel) {
			...
			gateway.read(mainService, object.popOverPath, {
					"filters": [chapa, centro, fechaDesde, fechaHasta]
				})
				.then(function (res) {
		...
		createCapacidadOciosaTonPopOver: function (centro, fechaDesde, fechaHasta, object, sel) {
			var popUpTable = new sap.m.Table({});
		...
		createMetaDespachoCustomPopOver: function (centro, fechaDesde, fechaHasta, object, sel) {
			...
			gateway.read(mainService, object.popOverPath, {
					"filters": [centro, fechaDesde, fechaHasta, chapa]
				})
				.then(function (res) {
					var responseSet = res.results;
		...
		createCustomPopOver: function (centro, fechaDesde, fechaHasta, object, sel) {
			var tablePopOver;
			switch (object.frameId) {
			case vizFrame.TiempoCiclo:
				tablePopOver = this.createTiempoCicloPopOver(centro, fechaDesde, fechaHasta, object, sel);
				break;
			case vizFrame.MetaDespacho:
				tablePopOver = this.createMetaDespachoCustomPopOver(centro, fechaDesde, fechaHasta, object, sel);
				break;
			case vizFrame.CapacidadOciosa:
				console.log("Capacidad Ociosa");
				break;
			case vizFrame.CapacidadOciosaTon:
				tablePopOver = this.createCapacidadOciosaTonPopOver(centro, fechaDesde, fechaHasta, object, sel);
				break;
